...
public class IntegerCastTest {
    ...
    public void selectAndCastToIntegerNoLength() throws SelectBuilderException {
        ...
        String query = new SelectBuilder(ctx)
                ...
                .build();
        assertEquals(query, "SELECT col1::INTEGER FROM sample_table;");
        ...
        query = new SelectBuilder(ctx)
                ...
                .fromTable("sample_table")
                .build();
        assertEquals(query, "SELECT CAST(col1 AS INTEGER) FROM sample_table;");
    }
    ...
    public void selectAndCastWithAliasToIntegerNoLength() throws SelectBuilderException {
        ...
        String query = new SelectBuilder(ctx)
                ...
                .fromTable("sample_table")
                .build();
        assertEquals(query, "SELECT col1::INTEGER AS c1 FROM sample_table;");
        ...
        query = new SelectBuilder(ctx)
                ...
                .fromTable("sample_table")
                .build();
        assertEquals(query, "SELECT CAST(col1 AS INTEGER) AS c1 FROM sample_table;");
    }
}
